...
print_colors() {
    ...
    for f in {0..7}; do
        ...
        printf "\033[${fg1}m%-30s\033[0m" "Fg1: ${fg1}"  # Standard foreground color

        # Column-2: Print bright color
        printf "\033[${fg2}m%-30s\033[0m" "Fg2: ${fg2}"  # Bright foreground color
    ...
    for f in {0..7}; do
        # Column-1: Print standard color
        printf "\033[${bg1}m%-30s\033[0m" "Bg1: ${bg1}"  # Standard foreground color

        # Column-2: Print bright color
        printf "\033[${bg2}m%-30s\033[0m" "Bg2: ${bg2}"  # Bright foreground color
