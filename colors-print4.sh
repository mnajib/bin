...
data=(
    ...
    "8,brightblack,#555753,90,100"  # Dark gray (for contrast) as Bright Black
    #"9,Bright_Red,#FF5555,91,101"    # Bright Red
    "9,brightred,#EF2929,91,101"    # Lighter red (for brightness) as Bright Red
    #"10,Bright_Green,#55FF55,92,102"  # as Bright Green
    "10,brightgreen,#8AE234,92,102"  # Lighter green (for brightness) as Bright Green
    #"11,Bright_Yellow,#FFFF55,93,103"  # as Bright Yellow
    "11,brightyellow,#FCE94F,93,103"  # Lighter yellow (for brightness) as Bright Yellow
    #"12,Bright_Blue,#5555FF,94,104"   # as Bright Blue
    "12,brightblue,#32AFFF,94,104"   # Lighter blue (for brightness) as Bright Blue
    #"13,Bright_Magenta,#FF55FF,95,105" # as Bright Magenta
    "13,brightmagenta,#AD7FA8,95,105" # Lighter magenta (for brightness) as Bright Magenta
    #"14,Bright_Cyan,#55FFFF,96,106"    # as Bright Cyan
    "14,brightcyan,#34E2E2,96,106"    # Lighter cyan (for brightness) as Bright Cyan
    "15,brightwhite,#FFFFFF,97,107"   # Pure white (kept as is) as Bright White (same as standard white)
)
