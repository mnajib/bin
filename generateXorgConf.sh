...
#
# NOTE:
#   The script (which should be re-run each time you run nixos-rebuild switch).
#   Add or remove to the pkgs and fontpkgs arrays according to your preference
#
# Before running:
