...
#watch gluster volume info $volumename &
tmux split-window -v -t .1 -p 50 "watch gluster volume info $volumename"
tmux split-window -h -t .2 -p 66 "watch gluster volume info $volumename2"
tmux split-window -h -t .3 -p 50 "watch gluster volume info $volumename3"
